    ...
    <tr><td align="center" style="padding:48px 16px;">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;">
        ...
        <tr><td style="padding:48px 48px 32px;text-align:center;border-bottom:1px solid #e8e8e8;">
          <img src="${LOGO_CDN_URL}" alt="Bell Carpets" width="160" style="width:160px;max-width:160px;display:block;margin:0 auto;" />
        </td></tr>
        ...
        <tr><td style="padding:32px 48px;text-align:center;background:#ffffff;border-top:1px solid #e8e8e8;">
          <img src="${LOGO_CDN_URL}" alt="Bell Carpets" width="120" style="width:120px;max-width:120px;display:block;margin:0 auto 12px;" />
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f5;">
    <tr><td align="center" style="padding:48px 16px;">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;">
        ...
        <!-- Header -->
        <tr><td style="padding:48px 48px 32px;text-align:center;border-bottom:1px solid #e8e8e8;">
          <img src="${LOGO_CDN_URL}" alt="Bell Carpets" width="160" style="width:160px;max-width:160px;display:block;margin:0 auto 8px;" />
        ...
        <tr><td style="padding:32px 48px;text-align:center;background:#ffffff;">
          <img src="${LOGO_CDN_URL}" alt="Bell Carpets" width="120" style="width:120px;max-width:120px;display:block;margin:0 auto;" />
        </td></tr>
